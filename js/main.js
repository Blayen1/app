...
/* harmony import */ var _components_db__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/db */ "./src/js/components/db.js");
/* harmony import */ var _components_db__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_db__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _functions_fixed_header__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./functions/fixed-header */ "./src/js/functions/fixed-header.js");
/* harmony import */ var _functions_fixed_header__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_functions_fixed_header__WEBPACK_IMPORTED_MODULE_1__);
...
(0,_functions_disable_scroll__WEBPACK_IMPORTED_MODULE_3__.disableScroll)();
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".product-slider", {
  slidesPerView: "auto",
  pagination: {
...
(function () {
  ...
  const menuItem = document.querySelectorAll("[data-navItem]");
  const overlay = document?.querySelector("[data-menu-overlay]");
  const burgerLogo = document.querySelector("[data-nav_burger_logo]");
  const burgerInfo = document.querySelector("[data-nav_burger_info]");
  const setOpacity = () => {
    overlay.style.opacity = 0;
    var el = overlay;
    var op = 0;
    while (op <= 1) {
      setTimeout(el.style.opacity = op, 60 + op * 300);
      op += 0.01;
    }
    overlay.style.display === "block" ? (overlay.style.display = "none", overlay.style.opacity = 0) : overlay.style.display = "block";
    burgerLogo.style.display === "block" ? burgerLogo.style.display = "none" : burgerLogo.style.display = "block";
    burgerInfo.style.display === "block" ? burgerInfo.style.display = "none" : burgerInfo.style.display = "block";
  };
...
/***/ "./src/js/functions/fixed-header.js":
/*!******************************************!*\
  !*** ./src/js/functions/fixed-header.js ***!
  \******************************************/
/***/ (() => {
